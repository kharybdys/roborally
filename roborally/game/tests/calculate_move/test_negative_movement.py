...
@pytest.mark.parametrize(
    ...
    [
        (Coord(x=1, y=2), Direction.SOUTH, -2, Coord(x=1, y=0)),
        (Coord(x=2, y=1), Direction.SOUTH, -1, Coord(x=2, y=0)),
        (Coord(x=0, y=1), Direction.WEST, -2, Coord(x=2, y=1)),
        (Coord(x=1, y=2), Direction.WEST, -1, Coord(x=2, y=2)),
        (Coord(x=1, y=0), Direction.NORTH, -2, Coord(x=1, y=2)),
        (Coord(x=2, y=1), Direction.NORTH, -1, Coord(x=2, y=2)),
        (Coord(x=2, y=1), Direction.EAST, -2, Coord(x=0, y=1)),
        (Coord(x=1, y=2), Direction.EAST, -1, Coord(x=0, y=2)),
    ],
)
